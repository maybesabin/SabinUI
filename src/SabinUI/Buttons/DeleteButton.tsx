...
const deleteButton = () => {
    ...
    const deleteButton = `<button className="px-5 py-2 rounded-lg text-[0.9rem] text-zinc-100 bg-red-500 hover:bg-red-600 cursor-pointer transition-all">Delete</button>`

    return (
        <div className="flex w-full flex-col items-start justify-start gap-6">

            <h1 className="text-2xl font-semibold">Delete Button</h1>
            ...
            <div className={`w-full border min-h-72 py-6 relative flex items-center justify-center rounded-lg`}>
                {
                    isActive == "preview" ?
                        <button className="px-5 py-2 rounded-lg text-[0.9rem] text-zinc-100 bg-red-500 hover:bg-red-600 cursor-pointer transition-all">Delete</button>

                        :
                        <>
                            <svg xmlns="http://www.w3.org/2000/svg" onClick={() => {
                                const updatedButton = deleteButton.replace("className", "class");
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" onClick={() => navigator.clipboard.writeText(deleteButton)} className="cursor-pointer absolute right-16 top-6 hover:scale-105" viewBox="0 0 24 24" width="24" height="24" fill="none">
