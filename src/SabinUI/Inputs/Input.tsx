                    ...
                    isActive == "preview" ?
                        ...
                        <>
                            <svg xmlns="http://www.w3.org/2000/svg" onClick={() => {
                                const updatedButton = Input.replace("className", "class");
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" onClick={() => navigator.clipboard.writeText(Input)} className="cursor-pointer absolute right-16 top-6 hover:scale-105" viewBox="0 0 24 24" width="24" height="24" fill="none">
