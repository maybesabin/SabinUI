...
const InputWithLabel = () => {
    ...
    <div className="flex flex-col items-start gap-1">
        ...
        bg-transparent rounded-lg text-[0.85rem]" placeholder="sabin@gmail.com" />
    </div>
    `
    ...
    return (
        <div className="flex w-full flex-col items-start justify-start gap-6">
            ...
            <h1 className="text-2xl font-semibold">Input With Label</h1>
                    ...
                    isActive == "preview" ?
                        ...
                        <>
                            <svg xmlns="http://www.w3.org/2000/svg" onClick={() => {
                                const updatedButton = InputWithLabel.replace("className", "class");
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" onClick={() => navigator.clipboard.writeText(InputWithLabel)} className="cursor-pointer absolute right-16 top-6 hover:scale-105" viewBox="0 0 24 24" width="24" height="24" fill="none">
