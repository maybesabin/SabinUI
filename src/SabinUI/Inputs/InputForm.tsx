...
const InputForm = () => {
    ...
    <div className="flex flex-col items-start justify-start gap-6 text-[0.85rem]">
        <div className="flex flex-col items-start gap-1">
            ...
            <input type="text" name="input" className="border border-[#262626] py-2 px-3 w-72 bg-transparent 
                    ...
                    isActive == "preview" ?
                        ...
                        <>
                            <svg xmlns="http://www.w3.org/2000/svg" onClick={() => {
                                const updatedButton = InputForm.replace("className", "class");
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" onClick={() => navigator.clipboard.writeText(InputForm)} className="cursor-pointer absolute right-16 top-6 hover:scale-105" viewBox="0 0 24 24" width="24" height="24" fill="none">
