...
const SkeletonUser = () => {
    ...
    <div className="flex items-center gap-2 text-[0.85rem]">
        <div className="dark:bg-[#202022] bg-zinc-300 rounded-full animate-pulse h-14 w-14"></div>
        <div className="flex flex-col items-start gap-2">
            <div className="dark:bg-[#202022] bg-zinc-300 rounded-md animate-pulse h-5 w-72"></div>
            <div className="dark:bg-[#202022] bg-zinc-300 rounded-md animate-pulse h-5 w-60"></div>
        </div>
    </div>
    ...
    return (
        <div className="flex w-full flex-col items-start justify-start gap-6">
            ...
            <h1 className="text-2xl font-semibold">User Card Skeleton</h1>
                    ...
                    isActive == "preview" ?
                        ...
                        <>
                            <svg xmlns="http://www.w3.org/2000/svg" onClick={() => {
                                const updatedButton = SkeletonUser.replace("className", "class");
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" onClick={() => navigator.clipboard.writeText(SkeletonUser)} className="cursor-pointer absolute right-16 top-6 hover:scale-105" viewBox="0 0 24 24" width="24" height="24" fill="none">
